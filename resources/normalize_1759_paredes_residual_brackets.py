#!/usr/bin/env python3
"""Clean remaining visible Paredes cross-reference bracket residue."""
...
PROPOSALS_PATH = Path("resources/paredes_1759_residual_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/paredes_1759_residual_bracket_summary.json")
SOURCE = "1759 Paredes"
RAW_FIELD = "Comentario_raw_1759_paredes_residual_brackets"
MARKER = "visible_1759_paredes_residual_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1759_paredes_residual_bracket_cleanup"
...
REPLACEMENTS = {
    "CALACO[HU]A": "CALACOHUA",
    "CUITLAXCOL[LI]": "CUITLAXCOLLI",
    "QUIXO[HU]A": "QUIXOHUA",
    "TENAHUATIL[LI]": "TENAHUATILLI",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_visible_paredes_residual_cross_reference_brackets_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
