#!/usr/bin/env python3
"""Normalize visible xilotl/jilotes residue in 1579 Duran."""
...
PROPOSALS_PATH = Path("resources/duran_1579_xilotl_display_proposals.tsv")
SUMMARY_PATH = Path("resources/duran_1579_xilotl_display_summary.json")
SOURCE = "1579 Durán"
RAW_FIELD = "Comentario_raw_1579_duran_xilotl_display"
MARKER = "visible_1579_duran_xilotl_display_2026_06_29"
QA_KEY = "qa_1579_duran_xilotl_display"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "normalized_visible_jilotes_spelling_for_xilotl_row",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
