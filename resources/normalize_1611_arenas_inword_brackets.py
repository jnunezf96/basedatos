#!/usr/bin/env python3
"""Remove in-word letter brackets in 1611 Arenas display text."""
...
PROPOSALS_PATH = Path("resources/arenas_1611_inword_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/arenas_1611_inword_bracket_summary.json")
SOURCE = "1611 Arenas"
RAW_FIELD = "Comentario_raw_1611_arenas_inword_brackets"
MARKER = "visible_1611_arenas_inword_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1611_arenas_inword_bracket_cleanup"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "removed_inword_square_brackets_from_1611_arenas_display_text",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
