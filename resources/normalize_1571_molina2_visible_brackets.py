#!/usr/bin/env python3
"""Clean residual visible square brackets in 1571 Molina 2 commentary."""
...
PROPOSALS_PATH = Path("resources/molina2_1571_visible_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/molina2_1571_visible_bracket_summary.json")
SOURCE = "1571 Molina 2"
RAW_FIELD = "Comentario_raw_1571_molina2_visible_brackets"
MARKER = "visible_1571_molina2_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1571_molina2_visible_bracket_cleanup"
...
REPLACEMENTS = {
    "oceuatoya.[ve]l.": "oceuatoya. vel.",
    "onichachalcac. [ve]l.": "onichachalcac. vel.",
    "[dicen solas las mujeres.]": "dicen solas las mujeres.",
    "[e]ncerado": "encerado",
    "a[]si": "a sí",
    "[]andar": "andar",
    "[la]grimas": "lágrimas",
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_residual_visible_square_brackets_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
