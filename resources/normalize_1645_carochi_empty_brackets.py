#!/usr/bin/env python3
"""Remove residual empty bracket separators from 1645 Carochi displays."""
...
PROPOSALS_PATH = Path("resources/carochi_1645_empty_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/carochi_1645_empty_bracket_summary.json")
SOURCE = "1645 Carochi"
RAW_FIELD = "Comentario_raw_1645_carochi_empty_brackets"
MARKER = "visible_1645_carochi_empty_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1645_carochi_empty_bracket_cleanup"
...
def normalize_piece(piece: str) -> tuple[str, list[tuple[str, str]]]:
    ...
    if not count:
        return piece, []
    return piece.replace("[]", ""), [("[]", "") for _ in range(count)]
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "removed_empty_square_bracket_separators_outside_small_and_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
