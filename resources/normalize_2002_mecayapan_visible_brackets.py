#!/usr/bin/env python3
"""Clean visible square-bracket metadata in 2002 Mecayapan."""
...
PROPOSALS_PATH = Path("resources/mecayapan_2002_visible_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/mecayapan_2002_visible_bracket_summary.json")
SOURCE = "2002 Mecayapan"
RAW_FIELD = "Comentario_raw_2002_mecayapan_visible_brackets"
MARKER = "visible_2002_mecayapan_bracket_cleanup_2026_06_29"
QA_KEY = "qa_2002_mecayapan_visible_bracket_cleanup"
...
def normalize_piece(piece: str) -> tuple[str, list[tuple[str, str]]]:
    ...
    for _ in range(10):
        ...
        def repl(match: re.Match[str]) -> str:
            old = match.group(0)
            new = replacement_for_match(match)
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "converted_visible_square_bracket_metadata_to_parentheses_outside_small_and_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
