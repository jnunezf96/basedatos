#!/usr/bin/env python3
"""Expand safe visible Molina 2 source-form bracket insertions."""
...
PROPOSALS_PATH = Path("resources/molina2_1571_source_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/molina2_1571_source_bracket_summary.json")
SOURCE = "1571 Molina 2"
RAW_FIELD = "Comentario_raw_1571_molina2_source_brackets"
MARKER = "visible_1571_molina2_source_bracket_expansion_2026_06_29"
QA_KEY = "qa_1571_molina2_source_bracket_expansion"
...
REPLACEMENTS = {
    "Moq[u]auhtelolouiani": "Moquauhtelolouiani",
    "onitlanonó[n]quaquixti": "onitlanonónquaquixti",
    "nó[n]tlatetzcaloa": "nóntlatetzcaloa",
    "onó[n]tlatetzcalo": "onóntlatetzcalo",
    "Tlacé[n]tililiztli": "Tlacéntililiztli",
    "cemmá[n]yan": "cemmányan",
    "Tenepá[n]tla": "Tenepántla",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "expanded_visible_molina2_source_form_brackets_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
