#!/usr/bin/env python3
"""Normalize narrow old-Spanish residue in 1580 Sahagun/Maynez display text."""
...
PROPOSALS_PATH = Path("resources/sahagun_maynez_1580_oldspanish_proposals.tsv")
SUMMARY_PATH = Path("resources/sahagun_maynez_1580_oldspanish_summary.json")
SOURCE = "1580 Sahagún/Máynez"
RAW_FIELD = "Comentario_raw_1580_sahagun_maynez"
MARKER = "visible_spanish_1580_sahagun_maynez_oldwriting_2026_06_29"
QA_KEY = "qa_1580_sahagun_maynez_oldwriting"
...
REPLACEMENTS = {
    "Dezendieron": "Descendieron",
    "dezendieron": "descendieron",
    "desendieron": "descendieron",
    "detruyeron": "destruyeron",
    "deziocheno": "décimo octavo",
    "Deziocheno": "Décimo octavo",
    "dezima": "décima",
    "Dezima": "Décima",
    "Dende a": "De ahí a",
    ...
    "quinze": "quince",
    "ymgen": "imagen",
    "Ynclinados": "Inclinados",
    "yreverencia": "irreverencia",
}
...
def normalize_outside_bold(value: object) -> tuple[str, list[tuple[str, str]]]:
    return normalize_piece(str(value or ""))
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "normalized_narrow_old_spanish_residue_in_public_display_fields",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
