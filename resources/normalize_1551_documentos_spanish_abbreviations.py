#!/usr/bin/env python3
"""Expand visible Spanish/name bracket abbreviations in 1551-95 Documentos.

The Documentos commentary is public legal-document display text. This pass only
expands a closed set of outside-bold Spanish/name abbreviations, preserving
editorial ``[sic]`` notes and all-uppercase cross-reference headwords.
"""
...
PROPOSALS_PATH = Path("resources/documentos_1551_spanish_abbreviation_proposals.tsv")
SUMMARY_PATH = Path("resources/documentos_1551_spanish_abbreviation_summary.json")
SOURCE = "1551-95 Documentos nahuas de la Ciudad de México"
RAW_FIELD = "Comentario_raw_1551_documentos_nahuas"
MARKER = "visible_spanish_1551_documentos_abbreviation_expansion_2026_06_29"
QA_KEY = "qa_1551_documentos_spanish_abbreviation_expansion"
...
REPLACEMENTS = {
    "Bernardi[n]o": "Bernardino",
    "Huitznahu[a]tl": "Huitznahuatl",
    "Migue[l]": "Miguel",
    "Xoc[o]": "Xoco",
    "algu[i]en": "alguien",
    "algui[e]n": "alguien",
    "co[mo]": "como",
    "conqui[s]ta": "conquista",
    "es[te]": "este",
    "po[r]": "por",
    "prego[nó]": "pregonó",
    "qui[e]ta": "quieta",
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "expanded_visible_spanish_and_name_abbreviations_outside_bold_examples",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
