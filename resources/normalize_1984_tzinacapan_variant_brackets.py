#!/usr/bin/env python3
"""Clean visible Tzinacapan variant-list brackets outside bold terms."""
...
PROPOSALS_PATH = Path("resources/tzinacapan_1984_variant_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/tzinacapan_1984_variant_bracket_summary.json")
SOURCE = "1984 Tzinacapan"
RAW_FIELD = "Comentario_raw_1984_tzinacapan_variant_brackets"
MARKER = "visible_1984_tzinacapan_variant_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1984_tzinacapan_variant_bracket_cleanup"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "removed_visible_tzinacapan_variant_list_brackets_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
