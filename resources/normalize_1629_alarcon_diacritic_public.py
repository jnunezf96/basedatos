#!/usr/bin/env python3
"""Normalize 1629 Alarcón grave/circumflex residue in public display fields."""
...
PROPOSALS_PATH = Path("resources/alarcon_1629_diacritic_public_proposals.tsv")
SUMMARY_PATH = Path("resources/alarcon_1629_diacritic_public_summary.json")
SOURCE = "1629 Alarcón"
MARKER = "visible_1629_alarcon_diacritic_public_2026_06_30"
QA_KEY = "qa_1629_alarcon_diacritic_public"

PUBLIC_FIELDS = ["Traducción", "Traducción (es)", "Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
RAW_FIELD_SUFFIX = "_raw_1629_alarcon_diacritic_public"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "normalized_grave_circumflex_residue_in_public_alarcon_fields",
                    "marker": MARKER,
