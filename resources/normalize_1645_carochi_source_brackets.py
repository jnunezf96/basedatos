#!/usr/bin/env python3
"""Expand safe visible Carochi source-form bracket insertions."""
...
PROPOSALS_PATH = Path("resources/carochi_1645_source_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/carochi_1645_source_bracket_summary.json")
SOURCE = "1645 Carochi"
RAW_FIELD = "Comentario_raw_1645_carochi_source_brackets"
MARKER = "visible_1645_carochi_source_bracket_expansion_2026_06_29"
QA_KEY = "qa_1645_carochi_source_bracket_expansion"
...
REPLACEMENTS = {
    ...
    "MA[ITL]": "MAITL",
    "YEC[TLI]": "YECTLI",
    "icnīuh[tli]": "icnīuhtli",
    "ìti[tl]": "ìtitl",
    "āxcā[itl]": "āxcāitl",
    "tlatqui[tl]": "tlatquitl",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "expanded_visible_carochi_source_form_brackets_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
