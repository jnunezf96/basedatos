#!/usr/bin/env python3
"""Clean exact visible translation brackets in 1780 Clavijero."""
...
PROPOSALS_PATH = Path("resources/clavijero_1780_translation_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/clavijero_1780_translation_bracket_summary.json")
SOURCE = "1780 Clavijero"
MARKER = "visible_1780_clavijero_translation_bracket_cleanup_2026_06_30"
QA_KEY = "qa_1780_clavijero_translation_bracket_cleanup"

PUBLIC_FIELDS = ["Traducción", "Traducción (es)"]
RAW_FIELD_SUFFIX = "_raw_1780_clavijero_translation_brackets"
BR_RE = re.compile(r"<br\s*/?>", re.I)
TAG_RE = re.compile(r"<[^>]+>")
REPLACEMENTS = {
    "que [cría] unas": "que cría unas",
}
