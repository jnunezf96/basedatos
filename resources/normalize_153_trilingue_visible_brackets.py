#!/usr/bin/env python3
"""Clean safe visible Trilingue bracket residue outside bold terms."""
...
PROPOSALS_PATH = Path("resources/trilingue_153_visible_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/trilingue_153_visible_bracket_summary.json")
SOURCE = "153? Trilingüe"
RAW_FIELD = "Comentario_raw_153_trilingue_visible_brackets"
MARKER = "visible_153_trilingue_bracket_cleanup_2026_06_29"
QA_KEY = "qa_153_trilingue_visible_bracket_cleanup"
...
REPLACEMENTS = {
    "[--]to. as.  >  [parento], -as.": "parento. as.  >  parento, -as.",
    "140v [--]to. as. > [parento], -as.": "140v parento. as. > parento, -as.",
    "[zan ilhuize oc ilhuice.]": "zan ilhuize oc ilhuice.",
    "[nitetlamaualnochilia]": "nitetlamaualnochilia",
    "[Cáncer enfermedad.]": "Cáncer enfermedad.",
    "[mijangos. fol. 195]": "mijangos. fol. 195",
    "[mijankos. F. 423]": "mijankos. F. 423",
    "[Acostumbrar]": "Acostumbrar",
    "[Antes sed.]": "Antes sed.",
    "[qualocatl]": "qualocatl",
    "iiaxca inteui[ot]ica": "iiaxca inteuiotica",
    "[rhomphaea]": "rhomphaea",
    "[rhophea.]": "rhophea.",
    "[tequiuhtia.]": "tequiuhtia.",
    "[ni]nipotza": "ninipotza",
    "[mi]ocuxcanemitiáni": "miocuxcanemitiáni",
    "g[raece]": "graece",
    "t[h]alamus": "thalamus",
    "[parento]": "parento",
    "[onis]": "onis",
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_safe_visible_trilingue_bracket_residue_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
