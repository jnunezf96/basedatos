#!/usr/bin/env python3
"""Clean safe visible editorial brackets in 1551-95 Documentos display text."""
...
PROPOSALS_PATH = Path("resources/documentos_1551_editorial_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/documentos_1551_editorial_bracket_summary.json")
SOURCE = "1551-95 Documentos nahuas de la Ciudad de México"
RAW_FIELD = "Comentario_raw_1551_documentos_editorial_brackets"
MARKER = "visible_editorial_1551_documentos_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1551_documentos_editorial_bracket_cleanup"
...
REPLACEMENTS = {
    "ANTIGU[O]": "ANTIGUO",
    "CAHUILITI[UH]": "CAHUILITIUH",
    "COMPRAR[SE]": "COMPRARSE",
    "HUELTIUH[TLI]": "HUELTIUHTLI",
    "ayudado[sic]": "ayudado [sic]",
    "la[sic]": "la [sic]",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "separated_visible_sic_notes_and_expanded_cross_reference_brackets",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
