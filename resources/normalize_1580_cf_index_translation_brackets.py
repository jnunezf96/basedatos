#!/usr/bin/env python3
"""Clean exact visible translation brackets in 1580 CF Index."""
...
PROPOSALS_PATH = Path("resources/cf_index_1580_translation_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/cf_index_1580_translation_bracket_summary.json")
SOURCE = "1580 CF Index"
MARKER = "visible_1580_cf_index_translation_bracket_cleanup_2026_06_30"
QA_KEY = "qa_1580_cf_index_translation_bracket_cleanup"

PUBLIC_FIELDS = ["Traducción", "Traducción (es)"]
RAW_FIELD_SUFFIX = "_raw_1580_cf_index_translation_brackets"
