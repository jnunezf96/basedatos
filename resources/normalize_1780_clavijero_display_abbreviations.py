#!/usr/bin/env python3
"""Expand safe visible bracket abbreviations in 1780 Clavijero commentary."""
...
PROPOSALS_PATH = Path("resources/clavijero_1780_display_abbreviation_proposals.tsv")
SUMMARY_PATH = Path("resources/clavijero_1780_display_abbreviation_summary.json")
SOURCE = "1780 Clavijero"
RAW_FIELD = "Comentario_raw_1780_clavijero"
MARKER = "visible_1780_clavijero_abbreviation_expansion_2026_06_29"
QA_KEY = "qa_1780_clavijero_display_abbreviation_expansion"
...
REPLACEMENTS = {
    "namechmach[tía]": "namechmachtía",
    "significación[e]s": "significaciones",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "expanded_visible_clavijero_display_abbreviations_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
