#!/usr/bin/env python3
"""Normalize one mechanical cedilla spelling in 1598 Tezozomoc commentary."""
...
PROPOSALS_PATH = Path("resources/tezozomoc_1598_mechanical_cedilla_proposals.tsv")
SUMMARY_PATH = Path("resources/tezozomoc_1598_mechanical_cedilla_summary.json")
SOURCE = "1598 Tezozomoc"
MARKER = "visible_1598_tezozomoc_mechanical_cedilla_2026_06_30"
QA_KEY = "qa_1598_tezozomoc_mechanical_cedilla"

DISPLAY_FIELDS = ["Traducción", "Traducción (es)", "Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
RAW_FIELD_BY_FIELD = {
    "Traducción": "Traduccion_raw_1598_tezozomoc_mechanical_cedilla",
    "Traducción (es)": "Traduccion_es_raw_1598_tezozomoc_mechanical_cedilla",
    "Comentario": "Comentario_raw_1598_tezozomoc_mechanical_cedilla",
    "Comentario (es)": "Comentario_es_raw_1598_tezozomoc_mechanical_cedilla",
    "Comentario_wimmer_plus_html": "Comentario_wimmer_plus_html_raw_1598_tezozomoc_mechanical_cedilla",
}
