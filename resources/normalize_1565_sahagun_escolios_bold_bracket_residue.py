#!/usr/bin/env python3
"""Normalize closed-set bracket restorations inside Escolios bold examples."""
...
PROPOSALS_PATH = Path("resources/sahagun_escolios_bold_bracket_residue_proposals.tsv")
SUMMARY_PATH = Path("resources/sahagun_escolios_bold_bracket_residue_summary.json")
SOURCE = "1565 Sahagún Escolios"
RAW_FIELD = "Comentario_raw_1565_sahagun_escolios_bold_bracket_residue"
MARKER = "visible_1565_escolios_bold_bracket_residue_expansion_2026_06_30"
QA_KEY = "qa_1565_escolios_bold_bracket_residue_expansion"
...
def token_context(value: object, token: str, width: int = 160) -> str:
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "expanded_public_bold_example_bracket_restorations",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
