#!/usr/bin/env python3
"""Replace visible ``[ ]`` space markers in 1629 Alarcón commentary."""
...
PROPOSALS_PATH = Path("resources/alarcon_1629_space_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/alarcon_1629_space_bracket_summary.json")
SOURCE = "1629 Alarcón"
RAW_FIELD = "Comentario_raw_1629_alarcon_space_brackets"
MARKER = "visible_1629_alarcon_space_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1629_alarcon_space_bracket_cleanup"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "replaced_visible_alarcon_space_brackets_with_spaces",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
