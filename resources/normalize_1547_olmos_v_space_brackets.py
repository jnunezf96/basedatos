#!/usr/bin/env python3
"""Replace visible ``[ ]`` space markers in 1547 Olmos_V public text."""
...
PROPOSALS_PATH = Path("resources/olmos_v_1547_space_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/olmos_v_1547_space_bracket_summary.json")
SOURCE = "1547 Olmos_V ?"
RAW_FIELD = "Comentario_raw_1547_olmos_v_space_brackets"
MARKER = "visible_1547_olmos_v_space_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1547_olmos_v_space_bracket_cleanup"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "replaced_visible_olmos_v_space_brackets_with_spaces",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
