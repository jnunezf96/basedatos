#!/usr/bin/env python3
"""Clean visible Arenas punctuation brackets outside bold examples."""
...
PROPOSALS_PATH = Path("resources/arenas_1611_punctuation_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/arenas_1611_punctuation_bracket_summary.json")
SOURCE = "1611 Arenas"
RAW_FIELD = "Comentario_raw_1611_arenas_punctuation_brackets"
MARKER = "visible_1611_arenas_punctuation_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1611_arenas_punctuation_bracket_cleanup"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_visible_arenas_punctuation_brackets_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
