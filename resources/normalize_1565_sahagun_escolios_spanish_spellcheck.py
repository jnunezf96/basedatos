#!/usr/bin/env python3
"""Normalize exact Spanish spellcheck residue in 1565 Sahagun Escolios display."""
...
PROPOSALS_PATH = Path("resources/sahagun_escolios_spanish_spellcheck_proposals.tsv")
SUMMARY_PATH = Path("resources/sahagun_escolios_spanish_spellcheck_summary.json")
SOURCE = "1565 Sahagún Escolios"
RAW_FIELD = "Comentario_raw_1565_sahagun_escolios"
MARKER = "visible_spanish_1565_escolios_spellcheck_residue_2026_06_29"
QA_KEY = "qa_1565_escolios_spanish_spellcheck_residue"

PUBLIC_FIELDS = ["Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
JSON_DISPLAY_PATH = ("Sahagun_Escolios_JSON", "display", "html")
BR_RE = re.compile(r"<br\s*/?>", re.I)
TAG_RE = re.compile(r"<[^>]+>")

REPLACEMENTS = {
    "conferir être si": "conferir entre sí",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "normalized_exact_spanish_spellcheck_residue_in_public_display_fields",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
