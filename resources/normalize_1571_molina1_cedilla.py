#!/usr/bin/env python3
"""Normalize visible cedilla old-writing in 1571 Molina 1 public fields."""
...
PROPOSALS_PATH = Path("resources/molina1_1571_cedilla_proposals.tsv")
SUMMARY_PATH = Path("resources/molina1_1571_cedilla_summary.json")
SOURCE = "1571 Molina 1"
MARKER = "visible_1571_molina1_cedilla_oldwriting_2026_06_29"
QA_KEY = "qa_1571_molina1_cedilla_oldwriting"

DISPLAY_FIELDS = ["Traducción", "Traducción (es)", "Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
RAW_FIELD_BY_FIELD = {
    "Traducción": "Traduccion_raw_1571_molina1_cedilla",
    "Traducción (es)": "Traduccion_es_raw_1571_molina1_cedilla",
    "Comentario": "Comentario_raw_1571_molina1_cedilla",
    "Comentario (es)": "Comentario_es_raw_1571_molina1_cedilla",
    "Comentario_wimmer_plus_html": "Comentario_wimmer_plus_html_raw_1571_molina1_cedilla",
}
...
def normalize_value(value: object) -> tuple[str, list[tuple[str, str]]]:
    ...
    return WORD_RE.sub(repl, text), changes
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "normalized_visible_cedilla_oldwriting_in_molina1_public_fields",
                    "marker": MARKER,
