#!/usr/bin/env python3
"""Expand safe visible display abbreviations in 1765 Cortes y Zedeno."""
...
PROPOSALS_PATH = Path("resources/cortes_y_zedeno_1765_display_abbreviation_proposals.tsv")
SUMMARY_PATH = Path("resources/cortes_y_zedeno_1765_display_abbreviation_summary.json")
SOURCE = "1765 Cortés y Zedeño"
RAW_FIELD = "Comentario_raw_1765_cortes_y_zedeno"
MARKER = "visible_1765_cortes_y_zedeno_abbreviation_expansion_2026_06_29"
QA_KEY = "qa_1765_cortes_y_zedeno_display_abbreviation_expansion"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "expanded_visible_cortes_y_zedeno_display_abbreviations_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
