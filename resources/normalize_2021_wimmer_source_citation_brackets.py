#!/usr/bin/env python3
"""Expand safe visible Wimmer source-citation bracket insertions.

Wimmer comments cite many Nahuatl source forms with editorial brackets. The raw
display is preserved separately; this pass expands a closed set of visible
bracket insertions where the intended reading is clear from the row, the cited
lemma, or ordinary n/m assimilation before labials.
"""
...
PROPOSALS_PATH = Path("resources/wimmer_2021_source_citation_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/wimmer_2021_source_citation_bracket_summary.json")
SOURCE = "2021 Wimmer"
RAW_FIELD = "Comentario_raw_2021_wimmer_source_citation_brackets"
MARKER = "visible_2021_wimmer_source_citation_bracket_expansion_2026_06_29"
QA_KEY = "qa_2021_wimmer_source_citation_bracket_expansion"
...
REPLACEMENTS = {
    "atlacueçona[n]chimallj": "atlacueçonanchimallj",
    "ate[n]chicalca[n]": "atenchicalcan",
    "atenchicalca[n]": "atenchicalcan",
    "amapa[n]yo": "amapanyo",
    "cé[n]neloa": "cénneloa",
    "co[n]maquiaia": "commaquiaia",
    "cuahu[i]": "cuahui",
    "cuicuiya[n]": "cuicuiyan",
    "eztlapa[n]qui": "eztlapanqui",
    "Eztlapa[n]qui": "Eztlapanqui",
    "ipa[n]": "ipan",
    "î[x]": "îx",
    "itonalopa[n]": "itonalopan",
    "motexovava[n]ticac": "motexovavanticac",
    "Motexovava[n]ticac": "Motexovavanticac",
    "nenacazi[cte]caliztli": "nenacazictecaliztli",
    "Nenacazi[Cte]Caliztli": "Nenacazictecaliztli",
    "netetequizpa[N]": "netetequizpan",
    "NETETEQUIZPA[N]": "NETETEQUIZPAN",
    "o[n]motemacato": "ommotemacato",
    "omoma[n]": "omoman",
    "papa[n]": "papan",
    "qua[m]mjmjlli": "quammjmjlli",
    "qua[n]mecatica": "quammecatica",
    "qui[n]yez": "quinyez",
    "qui[n]yôliuhtlamachtia": "quinyôliuhtlamachtia",
    "quiqueq[ue]chpanotihvi": "quiquequechpanotihvi",
    "quetzalhatzo[n]yatl": "quetzalhatzonyatl",
    "çaqua[n]papalotl": "çaquampapalotl",
    "TE[N]TILAOAC": "TENTILAOAC",
    "TE[N]tilaoac": "tentilaoac",
    "teyacapa[n]": "teyacapan",
    "tiqui[m]monônôchilia": "tiquimmonônôchilia",
    "tlapa[n]co": "tlapanco",
    "tlaquauhacocuil[i]tztli": "tlaquauhacocuilitztli",
    "Tlaye[a]uyotlaztli": "Tlayeauyotlaztli",
    "Y[x]quauit[i]": "Yxquauiti",
    "ymapa[n]ca": "ymapanca",
    "yatlacueçona[n]chimal": "yatlacueçonanchimal",
    "yqua[n]maxtli": "yquammaxtli",
    "yquetzalmapa[n]ca": "yquetzalmapanca",
    "ytonalloamaneapa[n]": "ytonalloamaneapan",
    "y[n]": "yn",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "expanded_visible_wimmer_source_citation_bracket_insertions_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
