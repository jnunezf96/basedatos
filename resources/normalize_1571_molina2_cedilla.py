#!/usr/bin/env python3
"""Normalize visible cedilla old-writing in 1571 Molina 2 public fields."""
...
PROPOSALS_PATH = Path("resources/molina2_1571_cedilla_proposals.tsv")
SUMMARY_PATH = Path("resources/molina2_1571_cedilla_summary.json")
SOURCE = "1571 Molina 2"
MARKER = "visible_1571_molina2_cedilla_oldwriting_2026_06_29"
QA_KEY = "qa_1571_molina2_cedilla_oldwriting"

DISPLAY_FIELDS = ["Traducción", "Traducción (es)", "Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
RAW_FIELD_BY_FIELD = {
    "Traducción": "Traduccion_raw_1571_molina2_cedilla",
    "Traducción (es)": "Traduccion_es_raw_1571_molina2_cedilla",
    "Comentario": "Comentario_raw_1571_molina2_cedilla",
    "Comentario (es)": "Comentario_es_raw_1571_molina2_cedilla",
    "Comentario_wimmer_plus_html": "Comentario_wimmer_plus_html_raw_1571_molina2_cedilla",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "normalized_visible_cedilla_oldwriting_in_molina2_public_fields",
                    "marker": MARKER,
