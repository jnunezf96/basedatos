#!/usr/bin/env python3
"""Normalize small safe brackets that correct the immediately preceding word."""
...
PROPOSALS_PATH = Path("resources/misc_preceding_bracket_corrections_proposals.tsv")
SUMMARY_PATH = Path("resources/misc_preceding_bracket_corrections_summary.json")
MARKER = "visible_misc_preceding_bracket_corrections_2026_06_30"
QA_KEY = "qa_misc_preceding_bracket_corrections"

DISPLAY_FIELDS = ["Traducción", "Traducción (es)", "Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
RAW_FIELD_BY_FIELD = {
    "Traducción": "Traduccion_raw_misc_preceding_bracket_corrections",
    "Traducción (es)": "Traduccion_es_raw_misc_preceding_bracket_corrections",
    "Comentario": "Comentario_raw_misc_preceding_bracket_corrections",
    "Comentario (es)": "Comentario_es_raw_misc_preceding_bracket_corrections",
    "Comentario_wimmer_plus_html": "Comentario_wimmer_plus_html_raw_misc_preceding_bracket_corrections",
}

REPLACEMENTS_BY_SOURCE = {
    "1692 Guerra": {
        "persino [persigno]": "persigno",
    },
    "1780 ? Bnf_361": {
        "arrojador [arrojado]": "arrojado",
        "baberos [babera]": "babera",
        "jarma [arma]": "arma",
        "refalgar [rejalgar]": "rejalgar",
        "sana [saña]": "saña",
    },
}
