#!/usr/bin/env python3
"""Resolve obvious Tezozomoc [?] display brackets from row context."""
...
PROPOSALS_PATH = Path("resources/tezozomoc_1598_uncertain_residual_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/tezozomoc_1598_uncertain_residual_bracket_summary.json")
SOURCE = "1598 Tezozomoc"
RAW_FIELD = "Comentario_raw_1598_tezozomoc_uncertain_residual_brackets"
MARKER = "visible_1598_tezozomoc_uncertain_residual_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1598_tezozomoc_uncertain_residual_bracket_cleanup"
...
REPLACEMENTS = {
    "Cihua[?]oatzin": "Cihuacoatzin",
    "top[?]xicalli": "topxicalli",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "resolved_obvious_tezozomoc_question_mark_brackets_from_row_context",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
