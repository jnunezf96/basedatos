#!/usr/bin/env python3
"""Expand safe visible bracket abbreviations in V94 SNP commentary."""
...
PROPOSALS_PATH = Path("resources/v94_snp_display_abbreviation_proposals.tsv")
SUMMARY_PATH = Path("resources/v94_snp_display_abbreviation_summary.json")
SOURCE = "V94 Diccionario Global SNP"
RAW_FIELD = "Comentario_raw_v94_snp"
MARKER = "visible_v94_snp_display_abbreviation_expansion_2026_06_29"
QA_KEY = "qa_v94_snp_display_abbreviation_expansion"
...
REPLACEMENTS = {
    "Ikuitapanomi[y]o": "Ikuitapanomiyo",
    "ajui[y]ak": "ajuiyak",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "expanded_visible_v94_snp_display_abbreviations_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
