#!/usr/bin/env python3
"""Clean remaining lowercase Tezozomoc display brackets outside bold terms."""
...
PROPOSALS_PATH = Path("resources/tezozomoc_1598_lowercase_residual_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/tezozomoc_1598_lowercase_residual_bracket_summary.json")
SOURCE = "1598 Tezozomoc"
RAW_FIELD = "Comentario_raw_1598_tezozomoc_lowercase_residual_brackets"
MARKER = "visible_1598_tezozomoc_lowercase_residual_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1598_tezozomoc_lowercase_residual_bracket_cleanup"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_visible_tezozomoc_lowercase_residual_brackets_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
