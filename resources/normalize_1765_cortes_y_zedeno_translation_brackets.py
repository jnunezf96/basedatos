#!/usr/bin/env python3
"""Clean exact visible translation brackets in 1765 Cortes y Zedeno."""
...
PROPOSALS_PATH = Path("resources/cortes_y_zedeno_1765_translation_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/cortes_y_zedeno_1765_translation_bracket_summary.json")
SOURCE = "1765 Cortés y Zedeño"
MARKER = "visible_1765_cortes_y_zedeno_translation_bracket_cleanup_2026_06_30"
QA_KEY = "qa_1765_cortes_y_zedeno_translation_bracket_cleanup"

PUBLIC_FIELDS = ["Traducción", "Traducción (es)"]
RAW_FIELD_SUFFIX = "_raw_1765_cortes_y_zedeno_translation_brackets"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_exact_visible_translation_brackets",
                    "marker": MARKER,
