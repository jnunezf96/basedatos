#!/usr/bin/env python3
"""Expand safe visible display bracket abbreviations in 1780 ? Bnf_361.

Bnf_361 commentary is mostly transcription/collation notes, and most bracketed
forms are Nahuatl source forms or editorial apparatus. This pass only expands a
small closed set of visible abbreviations whose resolution is explicit in the
same row or ordinary in the cited form.
"""
...
PROPOSALS_PATH = Path("resources/bnf_361_1780_display_abbreviation_proposals.tsv")
SUMMARY_PATH = Path("resources/bnf_361_1780_display_abbreviation_summary.json")
SOURCE = "1780 ? Bnf_361"
RAW_FIELD = "Comentario_raw_1780_bnf_361"
MARKER = "visible_1780_bnf_361_display_bracket_expansion_2026_06_29"
QA_KEY = "qa_1780_bnf_361_display_bracket_expansion"
...
REPLACEMENTS = {
    "Cuá[n]tas": "Cuántas",
    "[r]estés": "restés",
    "fréquent[s]": "fréquents",
    "pa[ra]": "para",
    "Tla-[tla]cama[n]titiui": "Tla-tlacamantitiui",
    "ni[c]to[c]a": "nictoca",
    "Te[t]zonteconeualiztli": "Tetzonteconeualiztli",
    "Te[t]zontecon": "Tetzontecon",
    "quá[n]locatl": "quánlocatl",
    "miectlamá[n]tli": "miectlamántli",
    "ne[c]auatilotiuh": "necauatilotiuh",
    "Ma[ç]a[ç]o [yuqui]": "Maçaço yuqui",
    "tla[ç]a": "tlaça",
    "a[l]laniliztli": "allaniliztli",
    "Nequixi[ti]liztli": "Nequixtiliztli",
    "Net[e]tlan[que]uiliztli": "Netetlanqueuiliztli",
    "Tlacatecoloxocouitz[t]li": "Tlacatecoloxocouitztli",
    "coloxocouitz[t]li": "coloxocouitztli",
    "Tlayeco[a]": "Tlayecoa",
    "qué[m]patiyoua": "quémpatiyoua",
    "qué[m]tlaçoti": "quémtlaçoti",
    "quezquitlamá[n]tli": "quezquitlamántli",
    "quezquicá[n]": "quezquicán",
    "quexquicá[n]": "quexquicán",
    "qui[n]yez": "quinyez",
    "í[n]": "ín",
    "q[ui]xtia": "quixtia",
    "Titianqui[ç]oa": "Titianquiçoa",
    "Tixten[c]uilchl": "Tixtencuilchil",
    "Tlaacoquiztili[z]tli": "Tlaacoquiztiliztli",
    "Tlaaui[l]qui[x]itiliztli": "Tlaauilquixitiliztli",
    "Tlaaui[l]qui[x]itiliz_tli": "Tlaauilquixitiliz_tli",
    "Tlaalpichil[l]izti": "Tlaalpichilliztli",
    "Tlac[e]ncaua": "Tlacencaua",
    "Tla[ce]cenuipantli": "Tlacecenuipantli",
    "Tla-[ce]cenuipantli": "Tla-cecenuipantli",
    "Nit[l]a": "Nitla",
    "cep[p]a": "ceppa",
    "Tlac[h]rismayotilli": "Tlachrismayotilli",
    "Tlacnopi[lh]uia": "Tlacnopilhuia",
    "Tlacocue[l]pacholi[z]tli": "Tlacocuelpacholiztli",
    "TlaxcipanuiaTla[c]xipani[uani]": "TlaxcipanuiaTlacxipaniuani",
    "T[l]aicno": "Tlaicno",
    "nemach[t]ililli": "nemachtililli",
    "tlaixihuilpinoniTlai[c]xiilpinoni": "tlaixihuilpinoniTlaicxiilpinoni",
    "Tlaixne[n]peualtilli": "Tlaixnenpeualtilli",
    "T[l]aixpanaliztli": "Tlaixpanaliztli",
    "Tlalalacal[t]": "Tlalalacatl",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "expanded_visible_bnf_361_display_bracket_abbreviations_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
