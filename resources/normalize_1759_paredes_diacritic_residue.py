#!/usr/bin/env python3
"""Normalize exact remaining Paredes public diacritic residues."""
...
PROPOSALS_PATH = Path("resources/paredes_1759_diacritic_residue_proposals.tsv")
SUMMARY_PATH = Path("resources/paredes_1759_diacritic_residue_summary.json")
SOURCE = "1759 Paredes"
MARKER = "visible_1759_paredes_diacritic_residue_2026_06_30"
QA_KEY = "qa_1759_paredes_diacritic_residue"

PUBLIC_FIELDS = ["Traducción", "Traducción (es)", "Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
RAW_FIELD_SUFFIX = "_raw_1759_paredes_diacritic_residue"

BR_RE = re.compile(r"<br\s*/?>", re.I)
TAG_RE = re.compile(r"<[^>]+>")
LETTER_CLASS = r"A-Za-zÀ-ÖØ-öø-ÿĀ-ž"
TARGET_RE = re.compile("[ÂÊÎÔÛâêîôûÇç]|Tloquee|Nahuaquēe")
...
REPLACEMENTS = {
    ...
    "âzo": "azo",
    "itlâ": "itla",
    "yuhquemmâ": "iuhquim ma",
    "yê": "ye",
    "cochcâyôtl": "cochcayotl",
    "neuhcâyôtl": "neuhcayotl",
    "ommoyetzticâ": "ommoyetztica",
    "ezzô": "ezo",
    "âmana": "amana",
    "nepâtiloni": "nepatiloni",
    "âzocâmo": "azocamo",
    "quêqueça": "quequeza",
    "ahimâ": "ahima",
    "inîquac": "inicuac",
...
def normalize_text(value: str) -> tuple[str, list[tuple[str, str]]]:
    ...
    return REPLACEMENT_RE.sub(repl, value), changes
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "normalized_exact_remaining_paredes_public_diacritic_residue",
                    "marker": MARKER,
