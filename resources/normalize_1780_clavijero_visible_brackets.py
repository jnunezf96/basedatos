#!/usr/bin/env python3
"""Clean final visible square-bracket residue in 1780 Clavijero commentary."""
...
PROPOSALS_PATH = Path("resources/clavijero_1780_visible_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/clavijero_1780_visible_bracket_summary.json")
SOURCE = "1780 Clavijero"
RAW_FIELD = "Comentario_raw_1780_clavijero_visible_brackets"
MARKER = "visible_1780_clavijero_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1780_clavijero_visible_bracket_cleanup"
...
REPLACEMENTS = {
    "[tiene en su poder]": "tiene en su poder",
    "[sic]": "(sic)",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_final_visible_square_bracket_residue_outside_small_and_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
