#!/usr/bin/env python3
"""Clean remaining visible Bnf_361 source-form bracket residue."""
...
PROPOSALS_PATH = Path("resources/bnf_361_1780_residual_source_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/bnf_361_1780_residual_source_bracket_summary.json")
SOURCE = "1780 ? Bnf_361"
RAW_FIELD = "Comentario_raw_1780_bnf_361_residual_source_brackets"
MARKER = "visible_1780_bnf_361_residual_source_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1780_bnf_361_residual_source_bracket_cleanup"
...
REPLACEMENTS = {
    "Tiyacapantla[t]tquit[t]": "Tiyacapantlatquitl",
    "Tiyacapantla[t]tquit": "Tiyacapantlatquitl",
    "Tlay[hi]yoyouilis[z]tli": "Tlayhiyouiliztli",
    "Tlacuilt[l]había": "Tlacuitlahuia",
    "T[l]lciciotcayeuani": "Talciciotcayeuani",
    "Tlaitztimot[t]aliani": "Tlaitztimotlaliani",
    "T[l]alixpanyotl": "Tlaixpanyotl",
    "Tlacama[t]tilani": "Tlacamatilani",
    "Tlacazolnanaut[l]i": "Tlacazolnanautli",
    "Tlacazolnanaut[l]": "Tlacazolnanautl",
    "Tlaye[a]uyotlaztli": "Tlayeauyotlaztli",
    "Y[x]quauit[i]": "Yxquauiti",
    "tlacatzau[a]tli": "tlacatzauatli",
    "qu[y]auac": "quiauac",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_visible_bnf_361_residual_source_form_brackets_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
