#!/usr/bin/env python3
"""Clean remaining visible Alarcon bracket residue outside bold examples."""
...
PROPOSALS_PATH = Path("resources/alarcon_1629_residual_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/alarcon_1629_residual_bracket_summary.json")
SOURCE = "1629 Alarcón"
RAW_FIELD = "Comentario_raw_1629_alarcon_residual_brackets"
MARKER = "visible_1629_alarcon_residual_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1629_alarcon_residual_bracket_cleanup"
...
REPLACEMENTS = {
    "[VER -TLA[TLI]]": "(VER -TLATLI)",
    "[VER ?TLA[TLI]]": "(VER TLATLI)",
    "TLA[TLI]": "TLATLI",
    "huei[ ]nacoztli[nacaztli])": "huei nacoztli (nacaztli)",
    "nacoztli[nacaztli]": "nacoztli (nacaztli)",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_visible_alarcon_residual_brackets_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
