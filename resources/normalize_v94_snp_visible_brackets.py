#!/usr/bin/env python3
"""Clean final visible commentary bracket residue in V94 Diccionario Global SNP."""
...
PROPOSALS_PATH = Path("resources/v94_snp_visible_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/v94_snp_visible_bracket_summary.json")
SOURCE = "V94 Diccionario Global SNP"
RAW_FIELD = "Comentario_raw_v94_snp_visible_brackets"
MARKER = "visible_v94_snp_bracket_cleanup_2026_06_29"
QA_KEY = "qa_v94_snp_visible_bracket_cleanup"
...
def main() -> int:
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "removed_editorial_brackets_from_commentary_placeholder",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
    ...
    write_tsv(
        args.proposals,
        proposals,
        ["record_id", "original", "editado", "translation", "marker", "old_tokens", "new_tokens", "context"],
    )
