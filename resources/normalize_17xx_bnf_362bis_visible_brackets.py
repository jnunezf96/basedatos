#!/usr/bin/env python3
"""Clean residual visible square brackets in 17?? Bnf_362bis prose."""
...
PROPOSALS_PATH = Path("resources/bnf_362bis_visible_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/bnf_362bis_visible_bracket_summary.json")
SOURCE = "17?? Bnf_362bis"
RAW_FIELD = "Comentario_raw_17xx_bnf_362bis_visible_brackets"
MARKER = "visible_17xx_bnf_362bis_bracket_cleanup_2026_06_29"
QA_KEY = "qa_17xx_bnf_362bis_visible_bracket_cleanup"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_residual_visible_square_brackets_outside_small_and_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
