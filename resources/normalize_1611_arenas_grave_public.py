#!/usr/bin/env python3
"""Normalize 1611 Arenas grave-accent residue in public display fields."""
...
PROPOSALS_PATH = Path("resources/arenas_1611_grave_public_proposals.tsv")
SUMMARY_PATH = Path("resources/arenas_1611_grave_public_summary.json")
SOURCE = "1611 Arenas"
MARKER = "visible_1611_arenas_grave_public_2026_06_30"
QA_KEY = "qa_1611_arenas_grave_public"

PUBLIC_FIELDS = ["Traducción", "Traducción (es)", "Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
RAW_FIELD_SUFFIX = "_raw_1611_arenas_grave_public"

BR_RE = re.compile(r"<br\s*/?>", re.I)
TAG_RE = re.compile(r"<[^>]+>")
GRAVE_RE = re.compile("[ÀÈÌÒÙàèìòù]")
WORD_RE = re.compile(r"[A-Za-zÀÈÌÒÙàèìòùĀĒĪŌŪāēīōūÂÊÎÔÛâêîôûÁÉÍÓÚÜÑáéíóúüñÇçÃÕãõ]+")
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "normalized_grave_accent_residue_in_public_arenas_fields",
                    "marker": MARKER,
