#!/usr/bin/env python3
"""Clean safe visible Alarcon inline bracket residue outside bold examples."""
...
PROPOSALS_PATH = Path("resources/alarcon_1629_inline_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/alarcon_1629_inline_bracket_summary.json")
SOURCE = "1629 Alarcón"
RAW_FIELD = "Comentario_raw_1629_alarcon_inline_brackets"
MARKER = "visible_1629_alarcon_inline_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1629_alarcon_inline_bracket_cleanup"
...
REPLACEMENTS = {
    "[debajo del oído, o en la quijada]": "debajo del oído, o en la quijada",
    "[para dolor de vientre o estomago]": "para dolor de vientre o estomago",
    "[tienen por agüeros]": "tienen por agüeros",
    "[Tlamacazque]": "Tlamacazque",
    "[conjuro]": "conjuro",
    "[blanca]": "blanca",
    "[hurto]": "hurto",
    "[lo que]": "lo que",
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_safe_visible_alarcon_inline_brackets_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
