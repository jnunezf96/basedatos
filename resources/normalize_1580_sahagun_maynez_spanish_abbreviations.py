#!/usr/bin/env python3
"""Expand visible Spanish bracket abbreviations in 1580 Sahagun/Maynez.

The remaining bracket residue for this source is public Spanish prose, not
Nahuatl term spelling. This pass expands a closed set of outside-bold Spanish
abbreviations and preserves the raw commentary before display changes.
"""
...
PROPOSALS_PATH = Path("resources/sahagun_maynez_1580_spanish_abbreviation_proposals.tsv")
SUMMARY_PATH = Path("resources/sahagun_maynez_1580_spanish_abbreviation_summary.json")
SOURCE = "1580 Sahagún/Máynez"
RAW_FIELD = "Comentario_raw_1580_sahagun_maynez"
MARKER = "visible_spanish_1580_sahagun_maynez_abbreviation_expansion_2026_06_29"
QA_KEY = "qa_1580_sahagun_maynez_spanish_abbreviation_expansion"
...
REPLACEMENTS = {
    "Ponían[les]": "Poníanles",
    "a[d]ormecimiento": "adormecimiento",
    "deb[e]ria": "deberia",
    "redond[a]": "redonda",
    "tañe[n]do": "tañendo",
    "tiene[n]": "tienen",
    "valiente[s]": "valientes",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "expanded_visible_spanish_abbreviations_outside_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
