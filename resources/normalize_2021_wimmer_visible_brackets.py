#!/usr/bin/env python3
"""Clean final visible empty square-bracket residue in 2021 Wimmer commentary."""
...
PROPOSALS_PATH = Path("resources/wimmer_2021_visible_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/wimmer_2021_visible_bracket_summary.json")
SOURCE = "2021 Wimmer"
RAW_FIELD = "Comentario_raw_2021_wimmer_visible_brackets"
MARKER = "visible_2021_wimmer_bracket_cleanup_2026_06_29"
QA_KEY = "qa_2021_wimmer_visible_bracket_cleanup"
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "cleaned_final_empty_square_bracket_residue_outside_small_and_bold",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
