#!/usr/bin/env python3
"""Normalize context-supported Spanish cedilla residue in 1629 Alarcon."""
...
PROPOSALS_PATH = Path("resources/alarcon_1629_context_spanish_cedilla_proposals.tsv")
SUMMARY_PATH = Path("resources/alarcon_1629_context_spanish_cedilla_summary.json")
SOURCE = "1629 Alarcón"
MARKER = "visible_1629_alarcon_context_spanish_cedilla_2026_06_30"
QA_KEY = "qa_1629_alarcon_context_spanish_cedilla"

DISPLAY_FIELDS = ["Traducción", "Traducción (es)", "Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
RAW_FIELD_BY_FIELD = {
    "Traducción": "Traduccion_raw_1629_alarcon_context_spanish_cedilla",
    "Traducción (es)": "Traduccion_es_raw_1629_alarcon_context_spanish_cedilla",
    "Comentario": "Comentario_raw_1629_alarcon_context_spanish_cedilla",
    "Comentario (es)": "Comentario_es_raw_1629_alarcon_context_spanish_cedilla",
    "Comentario_wimmer_plus_html": "Comentario_wimmer_plus_html_raw_1629_alarcon_context_spanish_cedilla",
}

OLD = "granos mas haçomados y hermosos"
NEW = "granos mas sazonados y hermosos"
        ...
        proposals.append(
            {
                ...
                "marker": MARKER,
                "old_tokens": " | ".join(f"{field}:{OLD}" for field in row_changes),
                "new_tokens": " | ".join(f"{field}:{NEW}" for field in row_changes),
                "context": context_for(row.get(row_changes[0], ""), NEW if args.apply else OLD),
            }
        )
