#!/usr/bin/env python3
"""Clean visible inline bracket residue in 1645 Carochi prose."""
...
PROPOSALS_PATH = Path("resources/carochi_1645_inline_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/carochi_1645_inline_bracket_summary.json")
SOURCE = "1645 Carochi"
RAW_FIELD = "Comentario_raw_1645_carochi_inline_brackets"
MARKER = "visible_1645_carochi_inline_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1645_carochi_inline_bracket_cleanup"
...
TAG_RE = re.compile(r"<[^>]+>")
WORD_EDGE_RE = re.compile(r"[\wÁÉÍÓÚÜÑáéíóúüñĀĒĪŌāēīōÀÈÌÒÙàèìòù]", re.U)
NUMERIC_NOTE_RE = re.compile(r"^\d+(?:\s+\w+)?$", re.U)
