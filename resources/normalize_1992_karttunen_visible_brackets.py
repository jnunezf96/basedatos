#!/usr/bin/env python3
"""Protect final visible source-citation bracket residue in 1992 Karttunen."""
...
PROPOSALS_PATH = Path("resources/karttunen_1992_visible_bracket_proposals.tsv")
SUMMARY_PATH = Path("resources/karttunen_1992_visible_bracket_summary.json")
SOURCE = "1992 Karttunen"
RAW_FIELD = "Comentario_raw_1992_karttunen_visible_brackets"
MARKER = "visible_1992_karttunen_bracket_cleanup_2026_06_29"
QA_KEY = "qa_1992_karttunen_visible_bracket_cleanup"
...
REPLACEMENTS = {
    "[(4)Bf.2r,4r,5r,6r]": "<small>[(4)Bf.2r,4r,5r,6r]</small>",
}
    ...
    for row in rows:
        ...
        if args.apply:
            ...
            qa = {
                **qa,
                QA_KEY: {
                    "action": "protected_source_citation_brackets_in_small_display_note",
                    "marker": MARKER,
                    "raw_field": RAW_FIELD,
                    "raw_preserved": True,
