#!/usr/bin/env python3
"""Normalize exact Spanish circumflex residue in public 1759 Paredes fields.

Most circumflex vowels in Paredes are Nahuatl headwords or examples and should
stay as source orthography. This pass is intentionally limited to repeated
Spanish gloss words in public display fields.
"""
...
PROPOSALS_PATH = Path("resources/paredes_1759_spanish_circumflex_proposals.tsv")
SUMMARY_PATH = Path("resources/paredes_1759_spanish_circumflex_summary.json")
SOURCE = "1759 Paredes"
MARKER = "visible_spanish_1759_paredes_circumflex_cleanup_2026_06_30"
QA_KEY = "qa_1759_paredes_spanish_circumflex_cleanup"

PUBLIC_FIELDS = ["Traducción", "Traducción (es)", "Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
RAW_FIELD_SUFFIX = "_raw_1759_paredes_spanish_circumflex"
BR_RE = re.compile(r"<br\s*/?>", re.I)
TAG_RE = re.compile(r"<[^>]+>")
LETTER_CLASS = r"A-Za-zÀ-ÖØ-öø-ÿĀ-ž"

REPLACEMENTS = {
    "aborrecerâ": "aborrecerá",
    "aduertirê": "advertiré",
    "coronarâ": "coronará",
    "criô": "crió",
    "estâ": "está",
...
def normalize_text(value: object) -> tuple[str, list[tuple[str, str]]]:
    ...
    return REPLACEMENT_RE.sub(repl, text), changes
