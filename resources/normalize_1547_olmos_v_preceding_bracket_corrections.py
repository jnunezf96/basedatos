#!/usr/bin/env python3
"""Normalize 1547 Olmos V brackets that correct the immediately preceding word."""
...
PROPOSALS_PATH = Path("resources/olmos_v_1547_preceding_bracket_corrections_proposals.tsv")
SUMMARY_PATH = Path("resources/olmos_v_1547_preceding_bracket_corrections_summary.json")
SOURCE = "1547 Olmos_V ?"
MARKER = "visible_1547_olmos_v_preceding_bracket_corrections_2026_06_30"
QA_KEY = "qa_1547_olmos_v_preceding_bracket_corrections"

DISPLAY_FIELDS = ["Traducción", "Traducción (es)", "Comentario", "Comentario (es)", "Comentario_wimmer_plus_html"]
RAW_FIELD_BY_FIELD = {
    "Traducción": "Traduccion_raw_1547_olmos_v_preceding_bracket_corrections",
    "Traducción (es)": "Traduccion_es_raw_1547_olmos_v_preceding_bracket_corrections",
    "Comentario": "Comentario_raw_1547_olmos_v_preceding_bracket_corrections",
    "Comentario (es)": "Comentario_es_raw_1547_olmos_v_preceding_bracket_corrections",
    "Comentario_wimmer_plus_html": "Comentario_wimmer_plus_html_raw_1547_olmos_v_preceding_bracket_corrections",
}

REPLACEMENTS = {
    "acar [azar]": "azar",
    "aguacarse [aguazarse]": "aguazarse",
    "algo [alguno]": "alguno",
    "amancebarte [amancebarse]": "amancebarse",
    "amargca [amargar]": "amargar",
    "apetrar [apretar]": "apretar",
    "arredondeca [arredondear]": "arredondear",
    "birlos [bolos]": "bolos",
    "caca [casa]": "casa",
    "casoronse [casaránse]": "casaránse",
    "cumo [zumo]": "zumo",
    "desengañar [desengañar]": "desengañar",
    "desmenuzar [desmenuzar]": "desmenuzar",
    "despeligar [despellejar]": "despellejar",
    "dido [dedo]": "dedo",
    "enjondrar [engendrar]": "engendrar",
    "escarmucar [escaramuzar]": "escaramuzar",
    "esforzar [esforzar]": "esforzar",
    "espomar [espumar]": "espumar",
    "hechicirca [hechicería]": "hechicería",
    "herbie [hervir]": "hervir",
    "hobe [hombre]": "hombre",
    "jasar [sajar]": "sajar",
    "madara [madera]": "madera",
    "mijor [mejor]": "mejor",
    "nondo [nudo]": "nudo",
    "paredas [paridas]": "paridas",
    "scepirar [suspirar]": "suspirar",
    "sebrepujar [sobrepujar]": "sobrepujar",
    "segar [secar]": "secar",
    "ser [sed]": "sed",
    "sonar [soñar]": "soñar",
    "tenbrar [temblar]": "temblar",
    "valle [balde]": "balde",
    "vanarse [bañarse]": "bañarse",
    "varde [verde]": "verde",
}
