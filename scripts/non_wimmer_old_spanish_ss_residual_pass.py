...
REPLACEMENTS: dict[str, tuple[str, str]] = {
    ...
    "abrasso": ("abrazo", "old_ss_spelling"),
    "acusso": ("acuso", "old_ss_spelling"),
    "altissimo": ("altísimo", "old_ss_spelling"),
    "amassada": ("amasada", "old_ss_spelling"),
    "amassado": ("amasado", "old_ss_spelling"),
    "amasso": ("amaso", "old_ss_spelling"),
    "apassionamiento": ("apasionamiento", "old_ss_spelling"),
    "apassionarse": ("apasionarse", "old_ss_spelling"),
    "aprenssar": ("aprensar", "old_ss_spelling"),
    "apressurado": ("apresurado", "old_ss_spelling"),
    "aquesse": ("aquese", "old_ss_spelling"),
    "aquessa": ("aquesa", "old_ss_spelling"),
    "asenssios": ("ajenjos", "old_ss_spelling"),
    "asossegar": ("sosegar", "old_ss_spelling"),
    "assado": ("asado", "old_ss_spelling"),
    "assan": ("asan", "old_ss_spelling"),
    "assaz": ("asaz", "old_ss_spelling"),
    "assentandole": ("asentándole", "old_ss_spelling"),
    "assentarme": ("asentarme", "old_ss_spelling"),
    "asserrada": ("aserrada", "old_ss_spelling"),
    "assida": ("asida", "old_ss_spelling"),
    "assistir": ("asistir", "old_ss_spelling"),
    "asso": ("aso", "old_ss_spelling"),
    "assolarse": ("asolarse", "old_ss_spelling"),
    "assomarse": ("asomarse", "old_ss_spelling"),
    "atrauiessa": ("atraviesa", "old_ss_u_v_spelling"),
    "auiessa": ("aviesa", "old_ss_u_v_spelling"),
    "auiesso": ("avieso", "old_ss_u_v_spelling"),
    "avisso": ("aviso", "old_ss_spelling"),
    "balssa": ("balsa", "old_ss_spelling"),
    "besso": ("beso", "old_ss_spelling"),
    "bossada": ("bosada", "old_ss_spelling"),
    "bossador": ("bosador", "old_ss_spelling"),
    "bossadura": ("bosadura", "old_ss_spelling"),
    "bossar": ("bosar", "old_ss_spelling"),
    "brossar": ("brosar", "old_ss_spelling"),
    "brassos": ("brazos", "old_ss_u_v_spelling"),
    "cassados": ("casados", "old_ss_spelling"),
    "casso": ("caso", "old_ss_spelling"),
    "compassionde": ("compasión de", "fused_old_ss_spelling"),
    "compassiua": ("compasiva", "old_ss_u_v_spelling"),
    "compassión": ("compasión", "old_ss_spelling"),
    "composission": ("composición", "old_ss_spelling"),
    "compromisso": ("compromiso", "old_ss_spelling"),
    "confessase": ("confesase", "old_ss_spelling"),
    "confessio": ("confesión", "old_ss_spelling"),
    "cossa": ("cosa", "old_ss_spelling"),
    "cómpassiua": ("compasiva", "old_ss_u_v_spelling"),
    "cónfessarse": ("confesarse", "old_ss_spelling"),
    "cónfessor": ("confesor", "old_ss_spelling"),
    "defenssa": ("defensa", "old_ss_spelling"),
    "desasossegándo": ("desasosegando", "old_ss_spelling"),
    "desassosegado": ("desasosegado", "old_ss_spelling"),
    "desatrauessada": ("desatravesada", "old_ss_u_v_spelling"),
    "descanssa": ("descansa", "old_ss_spelling"),
    "dessainar": ("desainar", "old_ss_spelling"),
    "dessarle": ("desearle", "old_ss_spelling"),
    "dessarrugamiento": ("desarrugamiento", "old_ss_spelling"),
    "dessaynado": ("desainado", "old_ss_spelling"),
    "dessaynamiento": ("desainamiento", "old_ss_spelling"),
    "dessaynarse": ("desainarse", "old_ss_spelling"),
    "dessearle": ("desearle", "old_ss_spelling"),
    "dessearme": ("desearme", "old_ss_spelling"),
    "dessearse": ("desearse", "old_ss_spelling"),
    "desseaua": ("deseaba", "old_ss_u_v_spelling"),
    "dessemejado": ("desemejado", "old_ss_spelling"),
    "desseosa": ("deseosa", "old_ss_spelling"),
    "desseándole": ("deseándole", "old_ss_spelling"),
    "dissimulado": ("disimulado", "old_ss_spelling"),
    "disposission": ("disposición", "old_ss_spelling"),
    "diuiesso": ("divieso", "old_ss_u_v_spelling"),
    "diuiessos": ("diviesos", "old_ss_u_v_spelling"),
    "empiesso": ("empiezo", "old_ss_spelling"),
    "enesse": ("en ese", "fused_old_ss_spelling"),
    "enhechisso": ("enhechizo", "old_ss_spelling"),
    "enprocession": ("en procesión", "fused_old_ss_spelling"),
    "espesissima": ("espesísima", "old_ss_spelling"),
    "espessado": ("espesado", "old_ss_spelling"),
    "essas": ("esas", "old_ss_spelling"),
    "expressa": ("expresa", "old_ss_spelling"),
    "falsso": ("falso", "old_ss_spelling"),
    "fossario": ("fosario", "old_ss_spelling"),
    "fuesses": ("fueses", "old_ss_spelling"),
    "grandissimo": ("grandísimo", "old_ss_spelling"),
    "grauissimo": ("gravísimo", "old_ss_u_v_spelling"),
    "grussura": ("grosura", "old_ss_spelling"),
    "hermosissimo": ("hermosísimo", "old_ss_spelling"),
    "huessa": ("huesa", "old_ss_spelling"),
    "impressa": ("impresa", "old_ss_spelling"),
    "impression": ("impresión", "old_ss_spelling"),
    "inquisission": ("inquisición", "old_ss_spelling"),
    "intercession": ("intercesión", "old_ss_spelling"),
    "irsse": ("irse", "old_ss_spelling"),
    "lejoss": ("lejos", "old_ss_spelling"),
    "loshuessos": ("los huesos", "fused_old_ss_spelling"),
    "manoss": ("manos", "old_ss_spelling"),
    "manssamente": ("mansamente", "old_ss_spelling"),
    "messarlo": ("mesarlo", "old_ss_spelling"),
    "necessidadal": ("necesidad al", "fused_old_ss_spelling"),
    "negligentissimo": ("negligentísimo", "old_ss_spelling"),
    "noblessa": ("nobleza", "old_ss_spelling"),
    "ocassion": ("ocasión", "old_ss_spelling"),
    "orejass": ("orejas", "old_ss_spelling"),
    "ossado": ("osado", "old_ss_spelling"),
    "osserio": ("osero", "old_ss_spelling"),
    "ossicio": ("oficio", "old_ss_spelling"),
    "passaria": ("pasaría", "old_ss_spelling"),
    "passartiempo": ("pasatiempo", "old_ss_spelling"),
    "passas": ("pasas", "old_ss_spelling"),
    "passean": ("pasean", "old_ss_spelling"),
    "passear": ("pasear", "old_ss_spelling"),
    "passen": ("pasen", "old_ss_spelling"),
    "passeo": ("paseo", "old_ss_spelling"),
    "passer": ("pacer", "old_ss_spelling"),
    "passiue": ("pasivamente", "old_ss_spelling"),
    "pessada": ("pesada", "old_ss_spelling"),
    "pessima": ("pésima", "old_ss_spelling"),
    "piensso": ("pienso", "old_ss_spelling"),
    "possibilidad": ("posibilidad", "old_ss_spelling"),
    "prepossn": ("preposición", "old_ss_spelling"),
    "prenssar": ("prensar", "old_ss_spelling"),
    "quantoss": ("cuantos", "old_ss_qu_spelling"),
    "rebossando": ("rebosando", "old_ss_spelling"),
    "rebosse": ("rebose", "old_ss_spelling"),
    "recompenssa": ("recompensa", "old_ss_spelling"),
    "remissión": ("remisión", "old_ss_spelling"),
    "repressada": ("represada", "old_ss_spelling"),
    "repressarse": ("represarse", "old_ss_spelling"),
    "sapientissimo": ("sapientísimo", "old_ss_spelling"),
    "sossegada": ("sosegada", "old_ss_spelling"),
    "sossegarse": ("sosegarse", "old_ss_spelling"),
    "ssierrass": ("sierras", "old_ss_spelling"),
    "ssopechando": ("sospechando", "old_ss_spelling"),
    "successo": ("suceso", "old_ss_spelling"),
    "successores": ("sucesores", "old_ss_spelling"),
    "sucesso": ("suceso", "old_ss_spelling"),
    "tantoss": ("tantos", "old_ss_spelling"),
    "tossegoso": ("tosegoso", "old_ss_spelling"),
    "tosso": ("toso", "old_ss_spelling"),
    "traspassa": ("traspasa", "old_ss_spelling"),
    "traspassada": ("traspasada", "old_ss_spelling"),
    "traspassando": ("traspasando", "old_ss_spelling"),
    "trassegar": ("trasegar", "old_ss_spelling"),
    "tuuiesse": ("tuviese", "old_ss_u_v_spelling"),
    "tuuiessedes": ("tuvieseis", "old_ss_u_v_spelling"),
    "tuuiessen": ("tuviesen", "old_ss_u_v_spelling"),
    "vessa": ("huesa", "old_ss_u_v_spelling"),
    "vesso": ("hueso", "old_ss_u_v_spelling"),
    "viesse": ("viese", "old_ss_spelling"),
    "yassi": ("y así", "fused_old_ss_spelling"),
    "ymprenssar": ("imprensar", "old_ss_y_spelling"),
    "ympressa": ("impresa", "old_ss_y_spelling"),
    "ympressor": ("impresor", "old_ss_y_spelling"),
    "ypassa": ("y pasa", "fused_old_ss_spelling"),
}
