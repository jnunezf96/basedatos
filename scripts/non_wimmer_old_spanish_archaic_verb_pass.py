...
CURATED_GLOSSES: dict[str, str] = {
    ...
    "enhiestar": "poner derecho o erguir",
    "enjerir": "injertar",
...
POST_CLEANUPS: list[tuple[re.Pattern[str], str, str]] = [
    ...
    (
        re.compile(r"\bdemediar\s+\(arcaico:\s+mediar,\s+gastar\s+o\s+llenar\s+hasta\s+la\s+mitad\)"),
        "demediar (arcaico: dejar a la mitad)",
        "tighten_demediar_gloss",
    ),
    (
        re.compile(r"\bDemediar\s+\(arcaico:\s+mediar,\s+gastar\s+o\s+llenar\s+hasta\s+la\s+mitad\)"),
        "Demediar (arcaico: dejar a la mitad)",
    ...
    (
        re.compile(r"\bdemediar\s+\(arcaico:\s+dejar\s+a\s+la\s+mitad\)\s+henchir\b"),
        "demediar (arcaico: dejar a la mitad), henchir",
        "punctuate_demediar_henchir_gloss",
    ),
    (
        re.compile(r"\bDemediar\s+\(arcaico:\s+dejar\s+a\s+la\s+mitad\)\s+henchir\b"),
        "Demediar (arcaico: dejar a la mitad), henchir",
    ...
    (
        re.compile(r"\bSordecer\s+\(arcaico:\s+ensordecer\),?\s+o\s+ensordecer\.?"),
        "Sordecer (arcaico: ensordecer).",
        "collapse_redundant_sordecer_gloss",
    ),
    (
        re.compile(r"\bsordecer\s+\(arcaico:\s+ensordecer\),?\s+o\s+ensordecer\.?"),
        "sordecer (arcaico: ensordecer).",
    ...
    (
        re.compile(r"\bsordecer\s+\(arcaico:\s+ensordecer\),?\s+o\s+ensordecerse\.?"),
        "sordecer (arcaico: ensordecer o ensordecerse).",
        "collapse_redundant_sordecer_gloss",
    ),
]
